...
@property (assign, nonatomic) PromptOutlineFloraInstantiateReceiverStyle defaultStyle UI_APPEARANCE_SELECTOR;
...
@property (assign, nonatomic) PromptOutlineFloraInstantiateReceiverMaskType defaultMaskType UI_APPEARANCE_SELECTOR;
...
@property (assign, nonatomic) PromptOutlineFloraInstantiateReceiverAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
