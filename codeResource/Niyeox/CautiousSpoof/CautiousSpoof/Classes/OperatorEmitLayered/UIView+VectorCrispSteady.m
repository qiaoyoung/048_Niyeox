...
//: @implementation UIView (VectorCrispSteady)
@implementation UIView (VectorCrispSteady)
...
- (void)setComplex:(CGFloat)sd_width
{
...
- (void)setTargetMap:(CGFloat)sd_height
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
