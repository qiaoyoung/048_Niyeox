...
//: @interface UIView (VectorCrispSteady)
@interface UIView (VectorCrispSteady)

//: @property (nonatomic, assign) CGFloat sd_height;
@property (nonatomic, assign) CGFloat targetMap;
//: @property (nonatomic, assign) CGFloat sd_width;
@property (nonatomic, assign) CGFloat complex;

//: @property (nonatomic, assign) CGFloat sd_x;
@property (nonatomic, assign) CGFloat scan;
