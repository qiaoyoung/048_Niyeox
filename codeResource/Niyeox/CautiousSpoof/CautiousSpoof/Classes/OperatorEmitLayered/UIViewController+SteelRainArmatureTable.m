...
- (void)setNavBarBackGroundColor:(UIColor *)color{
    [self.navigationController.navigationBar setBackgroundImage:[SkilledOptimalGesture getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:SkilledOptimalGestureDirectionLevel] forBarMetrics:UIBarMetricsDefault];
