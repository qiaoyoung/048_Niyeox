...
@interface AAAA_FFFKitSettings_BBBB()
{
    BOOL _isRight;
}
...
@implementation AAAA_FFFKitConfig_BBBB
...
{
    return @[[AAAA_FFFMediaItem_BBBB item:@"onTapMediaItemPicture:"
    ...
    [AAAA_FFFMediaItem_BBBB item:@"onTapMediaItemShoot:"
    ...
    [AAAA_FFFMediaItem_BBBB item:@"onTapMediaItemLocation:"
...
- (NSArray *)defaultMenuItemsWithMessage:(NIMMessage *)message
{
    ...
    {
        [menuItems addObject:[AAAA_FFFMediaItem_BBBB item:@"onTapMenuItemCopy:"
                                    normalImage:[UIImage imageNamed:@"bk_media_picture_normal"]
                                  selectedImage:[UIImage imageNamed:@"bk_media_picture_pressed"]
                                          title:LangKey(@"复制")]];
    }
    
//    AAAA_FFFMediaItem_BBBB *delItem = [AAAA_FFFMediaItem_BBBB item:@"onTapMenuItemDelete:"
//                                normalImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
...
- (void)applyDefaultSettings
{
    ...
    _avatarType = AAAA_MyUserAvatar_BBBBTypeRounded;
    _cellBackgroundColor = NEEKIT_UIColorFromRGB(0xE4E7EC);
    _leftBubbleSettings  = [[AAAA_FFFKitSettings_BBBB alloc] init:NO];
    _rightBubbleSettings = [[AAAA_FFFKitSettings_BBBB alloc] init:YES];
}

- (AAAA_FFFKitSetting_BBBB *)setting:(NIMMessage *)message
{
    AAAA_FFFKitSettings_BBBB *settings = message.isOutgoingMsg? self.rightBubbleSettings : self.leftBubbleSettings;
...
@implementation AAAA_FFFKitSettings_BBBB
...
{
    _repliedSetting = [[AAAA_FFFKitSetting_BBBB alloc] init];
...
{
    _textSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _audioSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _videoSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _fileSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _imageSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _locationSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _tipSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _rtcCallRecordSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _unsupportSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _teamNotificationSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _superTeamNotificationSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _chatroomNotificationSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
...
{
    _netcallNotificationSetting = [[AAAA_FFFKitSetting_BBBB alloc] init:_isRight];
