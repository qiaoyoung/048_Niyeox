...
@protocol AAAA_FFFSessionConfig_BBBB <NSObject>
@optional

/**
 *  输入按钮类型，请填入 AAAA_FFFInputBarItemType_BBBB 枚举，按顺序排列。不实现则按默认排列。
 */
 ...
 */
- (NSArray<AAAA_FFFMediaItem_BBBB *> *)mediaItems;
