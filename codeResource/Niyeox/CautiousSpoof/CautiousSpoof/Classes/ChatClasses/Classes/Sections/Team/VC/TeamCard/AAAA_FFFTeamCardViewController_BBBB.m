//
//  AAAA_FFFTeamCardViewController_BBBB.m
// AAAA_MyUserKit_BBBB
//
...
@interface AAAA_FFFTeamCardViewController_BBBB () <UITableViewDataSource,
                                         UITableViewDelegate,
...
@implementation AAAA_FFFTeamCardViewController_BBBB
...
#pragma mark - Private
- (id<AAAA_USERCardBodyData_BBBB>)bodyDataAtIndexPath:(NSIndexPath*)indexpath{
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    id<AAAA_USERCardBodyData_BBBB> bodyData = [self bodyDataAtIndexPath:indexPath];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    AAAA_TeamCardRowItemType_BBBB type = bodyData.type;
    switch (type) {
        case AAAA_TeamCardRowItemType_BBBBCommon:
            cell = [self builidCommonCell:bodyData indexPath:indexPath];
            break;
        case AAAA_TeamCardRowItemType_BBBBRedButton:
            cell = [self builidRedButtonCell:bodyData indexPath:indexPath];
            break;
        case AAAA_TeamCardRowItemType_BBBBBlueButton:
            cell = [self builidBlueButtonCell:bodyData ];
            break;
        case AAAA_TeamCardRowItemType_BBBBTeamMember:
            cell = [self builidTeamMemberCell:bodyData];
            break;
        case AAAA_TeamCardRowItemType_BBBBSwitch:
            cell = [self buildTeamSwitchCell:bodyData indexPath:indexPath];
            break;
        case AAAA_TeamCardRowItemType_BBBBSelected:
            cell = [self builidCommonCell:bodyData indexPath:indexPath];
        default:
            break;
    }
...
- (UITableViewCell*)builidCommonCell:(id<AAAA_USERCardBodyData_BBBB>) bodyData indexPath:(NSIndexPath *)indexPath
{
    NSString *identifier = [NSString stringWithFormat:@"builidCommonCell%ld%ld",(long)indexPath.section,(long)indexPath.row];
    AAAA_FFFGroupEditTableViewCell_BBBB * cell = [self.tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[AAAA_FFFGroupEditTableViewCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
        CGFloat left   = 60.f;
        CGFloat height = 1.f;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (bodyData.type == AAAA_TeamCardRowItemType_BBBBSelected) {
        AAAA_FFFTeamCardSelectedViewController_BBBB *vc = [AAAA_FFFTeamCardSelectedViewController_BBBB instanceWithTitle:bodyData.title
                                                                               items:bodyData.optionItems
                                                                              result:^(id<AAAA_FFFKitSelectCardData_BBBB>  _Nonnull item) {
...
- (UITableViewCell*)builidRedButtonCell:(id<AAAA_USERCardBodyData_BBBB>) bodyData indexPath:(NSIndexPath *)indexPath{
//    tableButtonCell
    NSString *identifier = [NSString stringWithFormat:@"tableButtonCell%ld%ld",(long)indexPath.section,(long)indexPath.row];
    AAAA_FFFKitColorButtonCell_BBBB * cell = [self.tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[AAAA_FFFKitColorButtonCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.button.style = AAAA_EnumColorButtonCell_BBBBStyleRed;
    [cell.button setTitle:bodyData.title forState:UIControlStateNormal];
    return cell;
}

- (UITableViewCell*)builidBlueButtonCell:(id<AAAA_USERCardBodyData_BBBB>) bodyData{
    AAAA_FFFKitColorButtonCell_BBBB * cell = [self.tableView dequeueReusableCellWithIdentifier:TableButtonCellReuseId];
    if (!cell) {
        cell = [[AAAA_FFFKitColorButtonCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:TableButtonCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.button.style = AAAA_EnumColorButtonCell_BBBBStyleBlue;
    [cell.button setTitle:bodyData.title forState:UIControlStateNormal];
    return cell;
}

- (UITableViewCell*)builidTeamMemberCell:(id<AAAA_USERCardBodyData_BBBB>) bodyData{
    AAAA_FFFTeamMemberListCell_BBBB * cell = [self.tableView dequeueReusableCellWithIdentifier:TableMemberCellReuseId];
    if (!cell) {
        cell = [[AAAA_FFFTeamMemberListCell_BBBB alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:TableMemberCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (UITableViewCell *)buildTeamSwitchCell:(id<AAAA_USERCardBodyData_BBBB>)bodyData indexPath:(NSIndexPath *)indexPath
{
    NSString *identifier = [NSString stringWithFormat:@"TableSwitch%ld%ld",(long)indexPath.section,(long)indexPath.row];
    AAAA_FFFTeamSwitchTableViewCell_BBBB *cell = [self.tableView dequeueReusableCellWithIdentifier:identifier];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    if (!cell) {
        cell = [[AAAA_FFFTeamSwitchTableViewCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
        CGFloat left   = 60.f;
        CGFloat height = 1.f;
        UIView *sep = [[UIView alloc] initWithFrame:CGRectMake(left, cell.device_height-height, cell.device_width-90, height)];
        sep.backgroundColor = NEEKIT_UIColorFromRGB(0xebebeb);
...
#pragma mark - Setter
- (void)setDatas:(NSArray<NSArray<AAAA_FFFTeamCardRowItem_BBBB *> *> *)datas {
    _datas = datas;
