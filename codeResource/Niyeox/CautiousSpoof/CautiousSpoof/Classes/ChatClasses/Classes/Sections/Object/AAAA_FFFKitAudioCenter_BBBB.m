...
@interface AAAA_FFFKitAudioCenter_BBBB()<NIMMediaManagerDelegate>

@property (nonatomic,assign) NSInteger retryCount;

@end

@implementation AAAA_FFFKitAudioCenter_BBBB

+ (instancetype)instance
{
    static AAAA_FFFKitAudioCenter_BBBB *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[AAAA_FFFKitAudioCenter_BBBB alloc] init];
    });
    return instance;
}
