...
@interface AAAA_FFFContactDataCell_BBBB()

@end

@implementation AAAA_FFFContactDataCell_BBBB
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _avatarImageView = [[AAAA_FFFAvatarImageView_BBBB alloc] initWithFrame:CGRectMake(15, 12, 48, 48)];
...
- (void)refreshAvatar:(AAAA_FFFKitInfo_BBBB *)info{
