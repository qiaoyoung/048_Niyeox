//
//  AAAA_FFFGrowingTextView_BBBB.m
// AAAA_MyUserKit_BBBB
//
...
@interface AAAA_FFFGrowingTextView_BBBB()<UITextViewDelegate>

@property (nonatomic,strong) AAAA_FFFGrowingInternalTextView_BBBB *textView;
...
@implementation AAAA_FFFGrowingTextView_BBBB
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        AAAA_FFFGrowingInternalTextView_BBBB *textView = [[AAAA_FFFGrowingInternalTextView_BBBB alloc] initWithFrame:rect];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        AAAA_FFFGrowingInternalTextView_BBBB *textView = [[AAAA_FFFGrowingInternalTextView_BBBB alloc] initWithFrame:CGRectZero];
        self.textView = textView;
...
@implementation AAAA_FFFGrowingTextView_BBBB(TextView)
