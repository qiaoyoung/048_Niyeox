...
@implementation AAAA_FFFKitUtil_BBBB
...
+ (NSString *)showNick:(NSString*)uid inMessage:(NIMMessage*)message
{
    ...
    return [[AAAA_MyUserKit_BBBB sharedKit] infoByUser:uid option:option].showName;
}
...
+ (NSString*)showTime:(NSTimeInterval) msglastTime showDetail:(BOOL)showDetail
{
    ...
    result = [AAAA_FFFKitUtil_BBBB getPeriodOfTime:hour withMinute:msgDateComponents.minute];
    if (hour > 12)
    {
        hour = hour - 12;
    }
    ...
    {
        NSString *weekDay = [AAAA_FFFKitUtil_BBBB weekdayStr:msgDateComponents.weekday];
    ...
    if (text == nil) {
        switch (message.messageType) {
            case NIMMessageTypeNotification:
                text = [AAAA_FFFKitUtil_BBBB notificationMessage:message];
                break;
...
+ (NSString *)notificationMessage:(NIMMessage *)message{
    ...
    switch (object.notificationType) {
        case NIMNotificationTypeTeam:{
            return [AAAA_FFFKitUtil_BBBB teamNotificationFormatedMessage:message];
        }
        case NIMNotificationTypeSuperTeam:{
            return [AAAA_FFFKitUtil_BBBB superTeamNotificationFormatedMessage:message];
        }
        case NIMNotificationTypeNetCall:{
            return [AAAA_FFFKitUtil_BBBB netcallNotificationFormatedMessage:message];
        }
        case NIMNotificationTypeChatroom:{
            return [AAAA_FFFKitUtil_BBBB chatroomNotificationFormatedMessage:message];
        }
        default:
            return @"";
    }
...
+ (NSString*)teamNotificationFormatedMessage:(NIMMessage *)message{
    ...
    if (object.notificationType == NIMNotificationTypeTeam)
    {
        ...
        NSString *source = [AAAA_FFFKitUtil_BBBB teamNotificationSourceName:message];
        NSArray *targets = [AAAA_FFFKitUtil_BBBB teamNotificationTargetNames:message];
        NSString *targetText = [targets count] > 1 ? [targets componentsJoinedByString:@","] : [targets firstObject];
        NSString *teamName = [AAAA_FFFKitUtil_BBBB teamNotificationTeamShowName:message];
...
+ (NSString*)superTeamNotificationFormatedMessage:(NIMMessage *)message{
    ...
    if (object.notificationType == NIMNotificationTypeSuperTeam)
    {
        ...
        NSString *source = [AAAA_FFFKitUtil_BBBB superTeamNotificationSourceName:message];
        NSArray *targets = [AAAA_FFFKitUtil_BBBB superTeamNotificationTargetNames:message];
        NSString *targetText = [targets count] > 1 ? [targets componentsJoinedByString:@","] : [targets firstObject];
        NSString *teamName = [AAAA_FFFKitUtil_BBBB superTeamNotificationTeamShowName:message];
...
+ (NSString *)rtcCallRecordFormatedMessage:(NIMMessage *)message {
    ...
    switch (record.callStatus) {
        ...
        case NIMRtcCallStatusComplete: {
            ...
            return [NSString stringWithFormat:@"%@ %@",LangKey(@"message_call_duration"),[AAAA_FFFKitUtil_BBBB durationTextWithSeconds:duration]];
        }
        default:
...
+ (NSString *)teamNotificationSourceName:(NIMMessage *)message{
    ...
    if ([content.sourceID isEqualToString:currentAccount]) {
        ...
        source = [AAAA_FFFKitUtil_BBBB showNick:content.sourceID inSession:message.session];
    }
    return source;
}
...
+ (NSArray *)teamNotificationTargetNames:(NIMMessage *)message{
    ...
    for (NSString *item in content.targetIDs) {
        if ([item isEqualToString:currentAccount]) {
            ...
            NSString *targetShowName = [AAAA_FFFKitUtil_BBBB showNick:item inSession:message.session];
