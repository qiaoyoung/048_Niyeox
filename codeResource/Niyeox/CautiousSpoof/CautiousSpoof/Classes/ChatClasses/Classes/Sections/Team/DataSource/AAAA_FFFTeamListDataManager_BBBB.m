//
//  AAAA_FFFTeamListDataManager_BBBB.m
// AAAA_MyUserKit_BBBB
//
...
@interface AAAA_FFFTeamListDataManager_BBBB ()<NIMTeamManagerDelegate>

@property (nonatomic, strong) NIMTeam *team;

@property (nonatomic, strong) NIMSession *session;

@property (nonatomic, strong) NSMutableArray <AAAA_FFFTeamCardMemberItem_BBBB *> *members;

@property (nonatomic, strong) NIMTeamMember *myTeamInfo;

@property (nonatomic, strong) AAAA_FFFTeamCardMemberItem_BBBB *myCard;

@end

@implementation AAAA_FFFTeamListDataManager_BBBB
...
- (NSMutableArray *)memberIds {
    ...
    [_members enumerateObjectsUsingBlock:^(AAAA_FFFTeamCardMemberItem_BBBB * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        if (obj.userId) {
...
- (AAAA_FFFTeamCardMemberItem_BBBB *)memberWithUserId:(NSString *)userId {
    __block AAAA_FFFTeamCardMemberItem_BBBB *ret = nil;
    [_members enumerateObjectsUsingBlock:^(AAAA_FFFTeamCardMemberItem_BBBB * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
#pragma mark - Private
- (void)addMemberItem:(AAAA_FFFTeamCardMemberItem_BBBB *)item {
    if (!item) {
        return;
    }
...
- (void)removeMemberItem:(NSString *)userId {
    for (AAAA_FFFTeamCardMemberItem_BBBB *obj in _members) {
        if ([obj.userId isEqualToString:userId]) {
...
- (void)addMembers:(NSArray <NIMTeamMember *>*)members {
    ...
    for (NIMTeamMember *member in members) {
        AAAA_FFFTeamCardMemberItem_BBBB *item = [[AAAA_FFFTeamCardMemberItem_BBBB alloc] initWithMember:member
                                                                           teamType:_team.type];
...
- (NIMTeamMember*)teamInfo:(NSString*)uid{
    for (AAAA_FFFTeamCardMemberItem_BBBB *member in _members) {
...
- (void)setMyTeamInfo:(NIMTeamMember *)myTeamInfo {
    ...
    _myCard = [[AAAA_FFFTeamCardMemberItem_BBBB alloc] initWithMember:myTeamInfo
                                                   teamType:_team.type];
}


- (void)updateMembersWithOption:(AAAA_FFFMembersFetchOption_BBBB *)option
...
- (void)handleAddManagers:(NSArray *)userIds
    ...
    if (!error) {
        for (NSString *userId in userIds) {
            [self.members enumerateObjectsUsingBlock:^(AAAA_FFFTeamCardMemberItem_BBBB * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                if ([obj.userId isEqualToString:userId]) {
...
- (void)handleFetchTeamMembers:(NSArray <NIMTeamMember *> *)members
                        option:(AAAA_FFFMembersFetchOption_BBBB *)option
                         error:(NSError *)error
                    completion:(NIMTeamListDataBlock)completion{
    NSString *msg = nil;
    if (!error) {
...
#pragma mark - <AAAA_FFFTeamOperation_BBBB>
...
- (void)fetchTeamMembersWithOption:(AAAA_FFFMembersFetchOption_BBBB *)option
                        completion:(NIMTeamListDataBlock)block {
    NSString *teamId = _team.teamId;
    __weak typeof(self) weakSelf = self;
    if (_team.type == NIMTeamTypeSuper) {
...
#pragma mark - <AAAA_FFFTeamMemberListDataSource_BBBB>
...
- (void)onTeamMemberChanged:(NIMTeam *)team {
    ...
    _team = team;
    AAAA_FFFMembersFetchOption_BBBB *option = [[AAAA_FFFMembersFetchOption_BBBB alloc] init];
