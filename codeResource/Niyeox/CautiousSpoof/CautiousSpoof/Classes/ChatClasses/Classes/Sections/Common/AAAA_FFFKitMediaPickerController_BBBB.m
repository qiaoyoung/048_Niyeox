//
//  AAAA_FFFKitMediaPickerController_BBBB.m
// AAAA_MyUserKit_BBBB
//
...
@interface AAAA_FFFKitMediaPickerController_BBBB ()<TZImagePickerControllerDelegate>

@property (nonatomic, assign) UIStatusBarStyle myStatusBarStyle;

@end

@implementation AAAA_FFFKitMediaPickerController_BBBB

- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount {
    if (self = [super initWithMaxImagesCount:maxImagesCount delegate:nil]) {
        self.navigationBar.barStyle = UIBarStyleBlack;
        self.pickerDelegate = self;
        self.naviBgColor = [UIColor colorWithPatternImage:[AAAA_SNGradientHelper_BBBB getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:AAAA_SNGradientHelper_BBBBDirectionLevel]];
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            [PHImageManager.defaultManager requestAVAssetForVideo:asset options:options resultHandler:^(AVAsset * _Nullable assetR, AVAudioMix * _Nullable audioMix, NSDictionary * _Nullable info) {
                ...
                if ([[info objectForKey:PHImageResultIsInCloudKey] boolValue]) {
                    ...
                    outputPath = [AAAA_FFFKitFileLocationHelper_BBBB filepathForVideo:outputFileName];
