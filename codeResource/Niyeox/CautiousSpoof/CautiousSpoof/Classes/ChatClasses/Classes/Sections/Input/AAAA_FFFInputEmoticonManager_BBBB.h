...
typedef NS_ENUM(NSInteger,AAAA_NIMEmoticonType_BBBB) {
    AAAA_NIMEmoticonType_BBBBFile = 0,
    AAAA_NIMEmoticonType_BBBBUnicode,
    AAAA_NIMEmoticonType_BBBBGif,
};

@interface AAAA_NIMInputEmoticon_BBBB : NSObject
@property (nonatomic,readonly)  AAAA_NIMEmoticonType_BBBB type;
...
@interface AAAA_NIMInputEmoticonLayout_BBBB : NSObject
...
@interface AAAA_NIMInputEmoticonCatalog_BBBB : NSObject
@property (nonatomic,strong)    AAAA_NIMInputEmoticonLayout_BBBB *layout;
...
@interface AAAA_FFFInputEmoticonManager_BBBB : NSObject
