...
@interface AAAA_FFFTeamAnnouncementListViewController_BBBB () <UITableViewDelegate,
                                                     UITableViewDataSource,
                                                     AAAA_USERCreateTeamAnnouncementDelegate_BBBB>

@property (nonatomic,strong) NSMutableArray *announcements;;
@property (nonatomic,strong) UITableView *tableView;
@property (nonatomic,strong) AAAA_NIMTeamAnnouncementListOption_BBBB *option;
...
@implementation AAAA_FFFTeamAnnouncementListViewController_BBBB
...
- (void)setOption:(AAAA_NIMTeamAnnouncementListOption_BBBB *)option {
    _option = option;
...
- (void)onCreateAnnouncement:(id)sender {
    AAAA_FFFCreateTeamAnnouncement_BBBB *vc = [[AAAA_FFFCreateTeamAnnouncement_BBBB alloc] initWithNibName:nil bundle:nil];
    vc.delegate = self;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [AAAA_FFFTeamAnnouncementListCell_BBBB cellHeight:content];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    NSDictionary *announcement = _announcements.lastObject;
    AAAA_FFFTeamAnnouncementListCell_BBBB *cell = [tableView dequeueReusableCellWithIdentifier:@"AAAA_FFFTeamAnnouncementListCell_BBBB"];
    if (!cell) {
        cell = [[AAAA_FFFTeamAnnouncementListCell_BBBB alloc] initWithStyle:(UITableViewCellStyleValue1) reuseIdentifier:@"AAAA_FFFTeamAnnouncementListCell_BBBB"];
    }
...
- (UIView *)defView{
    if(!_defView){
        ...
        if(_option.canCreateAnnouncement) {
            ...
            [emptyButton layoutButtonWithEdgeInsetsStyle:(AAAA_ImageTitleSpacing_BBBBEdgeInsetsStyleLeft) imageTitleSpace:10];
        }
...
//        _box.layer.shadowRadius = 12;
       ...
       [closeBtn setImage:[UIImage imageNamed:@"add_noticess"] forState:UIControlStateNormal];
        ...
        [closeBtn layoutButtonWithEdgeInsetsStyle:(AAAA_ImageTitleSpacing_BBBBEdgeInsetsStyleLeft) imageTitleSpace:10];
        ...
        [sureBtn layoutButtonWithEdgeInsetsStyle:(AAAA_ImageTitleSpacing_BBBBEdgeInsetsStyleLeft) imageTitleSpace:10];
...
@implementation AAAA_NIMTeamAnnouncementListOption_BBBB
@end
