...
//: @implementation AcrossRecordAbortExpose
@implementation AcrossRecordAbortExpose
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[TweakTheoryOf sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[TweakTheoryOf factoryAcross] immediatelyIn];
...
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [TweakTheoryOf sharedConfig].ignoreMessageType;
    NIMMessageType type = [TweakTheoryOf factoryAcross].driverHumor;
