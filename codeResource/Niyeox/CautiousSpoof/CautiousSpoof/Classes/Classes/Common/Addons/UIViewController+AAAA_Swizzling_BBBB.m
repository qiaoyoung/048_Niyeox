//
//  UIViewController+AAAA_Swizzling_BBBB.m
//  NIM
//
...
@implementation UIViewController (AAAA_Swizzling_BBBB)
...
- (instancetype)swizzling_initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil{
    ...
    if (instance) {
        if ([self isKindOfClass:NSClassFromString(@"AAAA_USERSessionListViewController_BBBB")] ||
            [self isKindOfClass:NSClassFromString(@"AAAA_CCCContactsViewController_BBBB")] ||
            [self isKindOfClass:NSClassFromString(@"AAAA_USERMainCenterViewController_BBBB")] ){
...
- (void)swizzling_viewWillAppear:(BOOL)animated{
    ...
    // 设置导航条背景图
//    UIImage *bgImg = [AAAA_SNGradientHelper_BBBB getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:AAAA_SNGradientHelper_BBBBDirectionLevel];
