...
@interface AAAA_ShowNotice_BBBB ()
...
@implementation AAAA_ShowNotice_BBBB
...
+ (AAAA_ShowNotice_BBBB *)showNoticeTo:(UIView *)view animated:(BOOL)animated 
{
    AAAA_ShowNotice_BBBB *notice = [[AAAA_ShowNotice_BBBB alloc] init];
