 ...
 *
 *
 *  @param menuModelsArray     下拉菜单模型数组,数组中存放着(BaselineMethodUpdateModel模型对象)
 ...
 *
 *  @param menuModelsArray     drop-down menu models array. Array storage BaselineMethodUpdateModel instances
...
///   >>步骤:
///   1、 [BaselineMethodUpdateView alloc] init]
///   2、 对需要赋值的属性进行赋值
...
/** 1、下拉菜单模型数组(数组里面存放 BaselineMethodUpdateBasedModel的子类的对象) 
 *     -----------------------------------------------------------
 *     English description:
 *     -----------------------------------------------------------
 ...
 *
 *               若不设置，默认为 @"BaselineMethodUpdateCell"
 *
 *     -----------------------------------------------------------
 *     English description:
 *     -----------------------------------------------------------
 *     drop-down nemu cell's class name. Must be a subclass of BaselineMethodUpdateBasedCell
 *              If want to use this framework's drop-down nemu cell, direct pass @"BaselineMethodUpdateCell"
