...
/**
 Error code specific to AAAA_SAMKeychain_BBBB that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, AAAA_SAMKeychain_BBBBErrorCode) {
	/** Some of the arguments were invalid. */
	AAAA_SAMKeychain_BBBBErrorBadArguments = -1001,
};

/** AAAA_SAMKeychain_BBBB error domain */
extern NSString *const kAAAA_SAMKeychain_BBBBErrorDomain;

/** Account name. */
extern NSString *const kAAAA_SAMKeychain_BBBBAccountKey;
 ...
 */
extern NSString *const kAAAA_SAMKeychain_BBBBCreatedAtKey;

/** Item class. */
extern NSString *const kAAAA_SAMKeychain_BBBBClassKey;

/** Item description. */
extern NSString *const kAAAA_SAMKeychain_BBBBDescriptionKey;

/** Item label. */
extern NSString *const kAAAA_SAMKeychain_BBBBLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kAAAA_SAMKeychain_BBBBLastModifiedKey;

/** Where the item was created. */
extern NSString *const kAAAA_SAMKeychain_BBBBWhereKey;
...
/**
 ...
 AAAA_SAMKeychain_BBBB has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface AAAA_SAMKeychain_BBBB : NSObject
...
/**
 ...
 See the `NSString` constants declared in AAAA_SAMKeychain_BBBB.h for a list of keys that can be used when accessing the
