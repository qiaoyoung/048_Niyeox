...
@interface AAAA_HMDataPicker_BBBB () <UIPickerViewDataSource, UIPickerViewDelegate>{
    
}
@property (nonatomic,weak) id<AAAA_HMDataPicker_BBBBDelegate> delegate;
...
@implementation AAAA_HMDataPicker_BBBB
