...
@interface AAAA_HMDataPicker_BBBBView (){
...
@implementation AAAA_HMDataPicker_BBBBView
...
+ (void)showInView:(UIView*)view delegate:(id<AAAA_HMDataPicker_BBBBViewDelegate>)delegate  minDate:(NSDate*)minDate maxDate:(NSDate*)maxDate showDate:(NSDate *)showDate{
    ...
    AAAA_HMDataPicker_BBBBView *pickerView = [[AAAA_HMDataPicker_BBBBView alloc]initWithFrame:CGRectMake(0, 0, [UIApplication sharedApplication].windows.firstObject.frame.size.width, view.frame.size.height)];
...
+ (id)showWithDelegate:(id<AAAA_HMDataPicker_BBBBViewDelegate>)delegate minDate:(NSDate*)minDate maxDate:(NSDate*)maxDate showDate:(NSDate*)showDate{
    AAAA_HMDataPicker_BBBBView *pickerView = [[AAAA_HMDataPicker_BBBBView alloc]initWithFrame:CGRectMake(0, 0, [UIApplication sharedApplication].windows.firstObject.frame.size.width, [UIApplication sharedApplication].windows.firstObject.frame.size.height)];
    pickerView.tag = 2006021272;
    if (minDate) {
        [pickerView.datePicker setMinimumDate:minDate];
    }
