...
@interface AAAA_TAPageControl_BBBB()
...
@implementation AAAA_TAPageControl_BBBB
...
- (void)initialization
{
    self.dotViewClass           = [AAAA_TAAnimatedDotView_BBBB class];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (touch.view != self) {
        ...
        if ([self.delegate respondsToSelector:@selector(AAAA_TAPageControl_BBBB:didSelectPageAtIndex:)]) {
            [self.delegate AAAA_TAPageControl_BBBB:self didSelectPageAtIndex:index];
        }
    }
}
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[AAAA_TAAnimatedDotView_BBBB class]] && self.dotColor) {
            ((AAAA_TAAnimatedDotView_BBBB *)dotView).dotColor = self.dotColor;
        }
    } else {
...
{
    if (self.dotViewClass) {
        AAAA_TAAbstractDotView_BBBB *abstractDotView = (AAAA_TAAbstractDotView_BBBB *)[self.dots objectAtIndex:index];
