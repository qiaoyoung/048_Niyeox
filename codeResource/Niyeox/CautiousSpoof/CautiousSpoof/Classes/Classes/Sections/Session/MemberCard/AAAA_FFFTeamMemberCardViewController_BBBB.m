...
@interface AAAA_FFFTeamMemberCardViewController_BBBB ()<NIMUserManagerDelegate>
...
@implementation AAAA_FFFTeamMemberCardViewController_BBBB
...
- (UIView *)personView
{
    if(!_personView){
        ...
        sublab2.text = [AAAA_FFFTeamHelper_BBBB memberTypeText:self.member.type];
