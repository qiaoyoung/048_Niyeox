//
//  AAAA_USERShareCardAttachment_BBBB.m
//  NIM
//
...
@implementation AAAA_USERShareCardAttachment_BBBB
...
- (NSString *)encodeAttachment {
    ...
    NSDictionary *dict = @{CMType: @(AAAA_USERCustomAttachmentInfo_BBBBTypeCard), CMData: dictContent};
...
{
    return @"AAAA_FFFSessionShareCardContentView_BBBB";
}
