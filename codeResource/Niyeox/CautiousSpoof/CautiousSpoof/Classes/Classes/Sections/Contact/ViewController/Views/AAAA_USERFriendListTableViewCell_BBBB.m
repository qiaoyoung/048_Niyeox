//
//  AAAA_USERFriendListTableViewCell_BBBB.m
//  NIM
//
...
@implementation AAAA_USERFriendListTableViewCell_BBBB
...
{
    static NSString *identifier = @"AAAA_USERFriendListTableViewCell_BBBB";
    AAAA_USERFriendListTableViewCell_BBBB *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell)
    {
        cell = [[AAAA_USERFriendListTableViewCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
//
...
- (void)refreshUser:(id<AAAA_NIMGroupMemberProtocol_BBBB>)member{
    ...
    AAAA_FFFKitInfo_BBBB *info = [[AAAA_MyUserKit_BBBB sharedKit] infoByUser:self.memberId option:nil];
...
- (void)refreshTeam:(NIMTeam *)team {
    ...
    AAAA_FFFKitInfo_BBBB *info = [[AAAA_MyUserKit_BBBB sharedKit] infoByTeam:self.memberId option:nil];
    NSURL *url = info.avatarUrlString ? [NSURL URLWithString:info.avatarUrlString] : nil;
