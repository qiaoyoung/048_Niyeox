...
@implementation AAAA_CCCContactPerson_BBBB

- (instancetype)initWithCNContact:(CNContact *)contact {
    self = [super init];
    if (self)
    {
        self.contactType = contact.contactType == CNContactTypePerson ? AAAA_SNContactType_BBBBTypePerson : AAAA_SNContactType_BBBBTypeOrigination;
        ...
        if ([contact isKeyAvailable:CNContactPhoneNumbersKey])
        {
            ...
            {
                if ([AAAA_NIMContactPhone_BBBB checkUserfulWithLabeledValue:labeledValue]) {
                    AAAA_NIMContactPhone_BBBB *phoneModel = [[AAAA_NIMContactPhone_BBBB alloc] initWithLabeledValue:labeledValue];
...
@implementation AAAA_NIMContactPhone_BBBB
...
@implementation AAAA_LJSectionPerson_BBBB
