//
//  AAAA_USERSystemSignNotificationSheet_BBBB.m
//  NIM
//
...
@interface AAAA_USERSystemSignNotificationSheet_BBBB ()
@property (nonatomic,strong) NSDictionary *originDict;
@property (nonatomic,strong) UIView *backView;
@end

@implementation AAAA_USERSystemSignNotificationSheet_BBBB
