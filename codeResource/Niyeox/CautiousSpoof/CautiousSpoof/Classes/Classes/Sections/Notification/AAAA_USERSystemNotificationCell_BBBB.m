//
//  AAAA_USERSystemNotificationCell_BBBB.m
//  NIM
//
...
@interface AAAA_USERSystemNotificationCell_BBBB ()

@property (nonatomic,strong) NIMSystemNotification *notification;
//@property (nonatomic,strong) IBOutlet AAAA_FFFAvatarImageView_BBBB *avatarImageView;
@end

@implementation AAAA_USERSystemNotificationCell_BBBB
...
- (void)updateUI{
    ...
    self.timeLabel.text = [AAAA_FFFKitUtil_BBBB showTime:self.notification.timestamp showDetail:YES];

    NSString *sourceID = self.notification.sourceID;
    AAAA_FFFKitInfo_BBBB *sourceMember = [[AAAA_MyUserKit_BBBB sharedKit] infoByUser:sourceID option:nil];
    [self updateSourceMember:sourceMember];
}

- (void)updateSourceMember:(AAAA_FFFKitInfo_BBBB *)sourceMember{
...
//    self.avatarImageView = [[AAAA_FFFAvatarImageView_BBBB alloc] initWithFrame:CGRectMake(0, 0, 40, 40)];
//    [self.contentView addSubview:self.avatarImageView];
//
