//
//  AAAA_USERSafetyTableViewCell_BBBB.m
//  NIM
//
...
@implementation AAAA_USERSafetyTableViewCell_BBBB
...
{
    static NSString *identifier = @"AAAA_USERSafetyTableViewCell_BBBB";
    AAAA_USERSafetyTableViewCell_BBBB *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell)
    {
        cell = [[AAAA_USERSafetyTableViewCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
