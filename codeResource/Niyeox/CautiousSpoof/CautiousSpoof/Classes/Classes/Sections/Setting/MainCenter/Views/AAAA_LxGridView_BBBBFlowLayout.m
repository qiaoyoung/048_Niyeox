//
//  AAAA_LxGridView_BBBBFlowLayout.m
//  AAAA_LxGridView_BBBB
//
...
/*
 此类来源于DeveloperLx的优秀开源项目：AAAA_LxGridView_BBBB
 github链接：https://github.com/DeveloperLx/AAAA_LxGridView_BBBB
 我对这个类的代码做了一些修改；
 感谢DeveloperLx的优秀代码~
 */

@interface AAAA_LxGridView_BBBBFlowLayout () <UIGestureRecognizerDelegate>

@property (nonatomic,readonly) id<AAAA_LxGridView_BBBBDataSource> dataSource;
@property (nonatomic,readonly) id<AAAA_LxGridView_BBBBDelegateFlowLayout> delegate;

@end

@implementation AAAA_LxGridView_BBBBFlowLayout
{
...
- (id<AAAA_LxGridView_BBBBDataSource>)dataSource
{
    return (id<AAAA_LxGridView_BBBBDataSource>)self.collectionView.dataSource;
}

- (id<AAAA_LxGridView_BBBBDelegateFlowLayout>)delegate
{
    return (id<AAAA_LxGridView_BBBBDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            AAAA_TZTestCell_BBBB *sourceCell = (AAAA_TZTestCell_BBBB *)sourceCollectionViewCell;
