//
//  AAAA_USERBlackListTableViewCell_BBBB.m
//  NIM
//
...
@implementation AAAA_USERBlackListTableViewCell_BBBB
...
{
    static NSString *identifier = @"AAAA_USERBlackListTableViewCell_BBBB";
    AAAA_USERBlackListTableViewCell_BBBB *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell)
    {
        cell = [[AAAA_USERBlackListTableViewCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
- (void)refreshWithMember:(AAAA_USERContactDataMember_BBBB *)member{
    self.member = member;
    self.labName.text = [AAAA_USERSessionUtil_BBBB showNick:member.info.infoId inSession:nil];
...
//    self.labName.text = data.nickname;
    ...
    AAAA_FFFKitInfo_BBBB *info = [[AAAA_MyUserKit_BBBB sharedKit] infoByUser:data.userId option:nil];
