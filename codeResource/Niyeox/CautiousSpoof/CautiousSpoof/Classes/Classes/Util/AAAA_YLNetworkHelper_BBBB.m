...
@implementation AAAA_YLNetworkHelper_BBBB
    ...
    [[AFNetworkReachabilityManager sharedManager] setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        switch (status) {
            case AFNetworkReachabilityStatusUnknown:
                networkStatus ? networkStatus(AAAA_YLNetworkHelper_BBBBStatusUnknown) : nil;
                if (_isOpenLog) PPLog(@"未知网络");
                break;
            case AFNetworkReachabilityStatusNotReachable:
                networkStatus ? networkStatus(AAAA_YLNetworkHelper_BBBBStatusNotReachable) : nil;
                if (_isOpenLog) PPLog(@"无网络");
                break;
            case AFNetworkReachabilityStatusReachableViaWWAN:
                networkStatus ? networkStatus(AAAA_YLNetworkHelper_BBBBStatusReachableViaWWAN) : nil;
                if (_isOpenLog) PPLog(@"手机自带网络");
                break;
            case AFNetworkReachabilityStatusReachableViaWiFi:
                networkStatus ? networkStatus(AAAA_YLNetworkHelper_BBBBStatusReachableViaWiFi) : nil;
...
+ (NSURLSessionTask *)GET:(NSString *)URL
    ...
    [self setResponseSerializer:(AAAA_YLNetworkHelper_BBBBResponseSerializerHTTP)];
...
+ (NSURLSessionTask *)POST:(NSString *)URL
    ...
    [self setResponseSerializer:(AAAA_YLNetworkHelper_BBBBResponseSerializerJSON)];
...
+ (void)setRequestSerializer:(AAAA_YLNetworkHelper_BBBBRequestSerializer)requestSerializer {
    _sessionManager.requestSerializer = requestSerializer==AAAA_YLNetworkHelper_BBBBRequestSerializerHTTP ? [AFHTTPRequestSerializer serializer] : [AFJSONRequestSerializer serializer];
}

+ (void)setResponseSerializer:(AAAA_YLNetworkHelper_BBBBResponseSerializer)responseSerializer {
    _sessionManager.responseSerializer = responseSerializer==AAAA_YLNetworkHelper_BBBBResponseSerializerHTTP ? [AFHTTPResponseSerializer serializer] : [AFJSONResponseSerializer serializer];
}
