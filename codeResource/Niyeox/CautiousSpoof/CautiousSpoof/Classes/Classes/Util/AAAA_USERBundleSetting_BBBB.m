...
@implementation AAAA_USERBundleSetting_BBBB

+ (instancetype)sharedConfig
{
    static AAAA_USERBundleSetting_BBBB *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[AAAA_USERBundleSetting_BBBB alloc] init];
    });
    return instance;
}
