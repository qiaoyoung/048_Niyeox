...
//: @interface PruneRestDurationReturn : NSObject
@interface PruneRestDurationReturn : NSObject
...
@property (nonatomic,assign) NSInteger logNorth;
...
@property (nonatomic,copy) NSString *automaticallyDecorate;
...
@property (nonatomic,assign) NSTimeInterval enable;
