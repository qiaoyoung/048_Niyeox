...
extern __attribute__((visibility ("default"))) NSString *const styleDistinctResult(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const userSumeractPath(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const commonBarPath(NSString *value);/** 即时聊天*/
