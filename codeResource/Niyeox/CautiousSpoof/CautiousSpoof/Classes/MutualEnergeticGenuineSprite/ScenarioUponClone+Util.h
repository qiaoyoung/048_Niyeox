...
//: @interface ScenarioUponClone (Util)
@interface ScenarioUponClone (Util)



//: @property (nonatomic ,strong) NSString *isclear;
@property (nonatomic ,strong) NSString *automatic;//是否清屏 0 是正常 1 是清理
//: @property (nonatomic ,strong) NSString *logininfo;
@property (nonatomic ,strong) NSString *backMendCalm;//登录页自定义信息
...
@property (nonatomic ,strong) NSString *entity;//是/开启微信登录
...
@property (nonatomic ,strong) NSString *phase;// chatnotify = "http://18.162.124.224:12008/api/chatNotify";
//: @property (nonatomic ,strong) NSString *webViewURL;
@property (nonatomic ,strong) NSString *radarStorm;

//: @property (nonatomic ,strong) NSString *tempVerificationInfo;
@property (nonatomic ,strong) NSString *stackUniversal;//加好友验证消息
//: @property (nonatomic ,strong) NSString *istsbutton;
@property (nonatomic ,strong) NSString *visible;//是否开启探索tab
//: @property (nonatomic ,strong) NSString *friendsCircle;
@property (nonatomic ,strong) NSString *triumphSign;//是否朋友圈
//: @property (nonatomic ,strong) NSString *showMessageRead; 
@property (nonatomic ,strong) NSString *technologyJet;// 是否显示已读未读组件 1=显示 ，0=隐藏 默认显示
//: @property (nonatomic ,strong) NSString *accountName;
@property (nonatomic ,strong) NSString *cableSpot;
//: @property (nonatomic ,strong) NSString *nimToken;
@property (nonatomic ,strong) NSString *thin;
//: @property (nonatomic ,assign) BOOL canSendText;
@property (nonatomic ,assign) BOOL timing;
//: @property (nonatomic ,assign) BOOL noScreen;
@property (nonatomic ,assign) BOOL bootStage;
...
@property (nonatomic ,strong) NSString *lab;//红包是否开启


//: @property (nonatomic ,strong) NSString *language;
@property (nonatomic ,strong) NSString *recordWish;
//: @property (nonatomic ,strong) NSString *isspeakingtime;
@property (nonatomic ,strong) NSString *toneFrom;//是否控制发言间隔时间
//: @property (nonatomic ,strong) NSString *umappkey_ios;
@property (nonatomic ,strong) NSString *happy;//umeng_Key
//: @property (nonatomic ,strong) NSString *isinvitecode;
@property (nonatomic ,strong) NSString *noticeCompareHidden;//邀请码是否必填
//: @property (nonatomic ,strong) NSString *yspop;
@property (nonatomic ,strong) NSString *kindCapability;//隐私协议弹窗

//: @property (nonatomic ,strong) NSString *allowdeletion; 
@property (nonatomic ,strong) NSString *readyAfter;//显示隐藏删除好友按钮 = 1 显示删除 ，=0隐藏
//: @property (nonatomic ,strong) NSString *appkey;
@property (nonatomic ,strong) NSString *wild;

//: @property (nonatomic ,strong) NSString *isregitor;
@property (nonatomic ,strong) NSString *listen;//1 允许注册 0 不允许

//: @property (nonatomic ,strong) NSString *accid;
@property (nonatomic ,strong) NSString *brilliant;

//: @property (nonatomic ,strong) NSString *issecret;
@property (nonatomic ,strong) NSString *added;//是否强制密保

//: @property (nonatomic ,strong) NSString *islogin;
@property (nonatomic ,strong) NSString *downMain;//是否踢下线 0 踢下线 1是正常
...
@property (nonatomic ,strong) NSString *execute;//是否开启签到
//: @property (nonatomic ,strong) NSString *servicer;
@property (nonatomic ,strong) NSString *lockCircuit;//在线客服地址
//: @property (nonatomic ,strong) NSString *pCode; 
@property (nonatomic ,strong) NSString *lengthPrimeReason;//密码
//@property (nonatomic ,assign) BOOL canSendText;
