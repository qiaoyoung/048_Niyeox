...
//: @implementation UIImage (ColumnQuota)
@implementation UIImage (ColumnQuota)
...
- (UIImage *)empty
{
    //: CGFloat pixels = [[ScalabilityCircuitPingPrefetchWhiten currentDevice] suggestImagePixels];
    CGFloat pixels = [[ScalabilityCircuitPingPrefetchWhiten truthForget] clean];
    //: UIImage * image = [self imageForUpload:pixels];
    UIImage * image = [self tillPressRestore:pixels];
    //: return [image fixOrientation];
    return [image shouldBalanced];
}


//: - (UIImage *)drawImageWithSize: (CGSize)size
- (UIImage *)blend: (CGSize)size
{
...
- (UIImage *)should: (CGFloat)maxPixels
{
...
- (UIImage *)tillPressRestore: (CGFloat)suggestPixels
{
        ...
        (width / height > kMaxRatio || height / width > kMaxRatio))
    {
        ...
        return [self should:kMaxPixels];
    }
    //: else
    else
    {
        //: return [self scaleWithMaxPixels:suggestPixels];
        return [self should:suggestPixels];
    }
}
