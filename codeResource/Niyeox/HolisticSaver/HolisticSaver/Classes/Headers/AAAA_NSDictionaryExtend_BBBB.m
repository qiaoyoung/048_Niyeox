//
//  AAAA_NSDictionaryExtend_BBBB.m
//  sohunews
//
...
@interface AAAA_NSStack_BBBB : NSObject {
...
@implementation AAAA_NSStack_BBBB
- (id) init {
    self = [super init];
    if (self) {
...
- (NSString *)toXMLString {
    ...
    AAAA_NSStack_BBBB *stack = [[AAAA_NSStack_BBBB alloc] init];
    NSArray  *keys = nil;
    NSString *key  = nil;
    NSObject *value    = nil;
