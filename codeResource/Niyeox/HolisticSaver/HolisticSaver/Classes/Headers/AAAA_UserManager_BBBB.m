...
@implementation AAAA_UserManager_BBBB

//判断是否登录
+(BOOL)isLogin
{
//    if ([AAAA_MyUserDefaults_BBBB standardUserDefaults].user_id.length>0) {
//        return YES;
//    }else{
//        return NO;
//    }
...
//        //[BYPLVVodSDK setCacheDir];
//
//        [HAAAA_HttpManager_BBBB removeAllHttpCache];
//        //Noti_Post(UserLogout, nil);
//    }SK_MAIN_THREAD_END
}

+ (NSString *)getUserId{
    NSString *userId = [AAAA_MyUserDefaults_BBBB standardUserDefaults].accid;
    return userId;
}


//+ (NSString *)getMobileNumber{
//    NSString *UserNo = emptyString([AAAA_MyUserDefaults_BBBB standardUserDefaults].mobile);
//    return UserNo;
//}
//
//+ (NSString *)getHeaderImageUrl{
//    NSString *headImageUrl = emptyString([AAAA_MyUserDefaults_BBBB standardUserDefaults].head_img);
//    return headImageUrl;
//}
//+ (NSString *)getNickName{
//    NSString *headImageUrl = emptyString([AAAA_MyUserDefaults_BBBB standardUserDefaults].user_nickname);
//    return headImageUrl;
//}
//
//+ (void)callSevicePhoneNumber{
//    NSMutableString * string = [[ NSMutableString alloc] initWithFormat: @"tel:%@", [AAAA_MyUserDefaults_BBBB standardUserDefaults].serverPhoneNumber];
//    [[ UIApplication sharedApplication] openURL:[ NSURL URLWithString:string]];
//}
//+ (NSString *)setPrefixURLWithURL:(NSString *)imageurl{
//    NSString *prefixStr = [AAAA_MyUserDefaults_BBBB standardUserDefaults].prefixURL;
//
...
//    NSString *prefixStr = [AAAA_MyUserDefaults_BBBB standardUserDefaults].prefixURL;
//    NSString *suffixStr = [AAAA_MyUserDefaults_BBBB standardUserDefaults].thumbURL;
...
//+ (NSString *)getApikey{
//    NSString *apikey = emptyString([AAAA_MyUserDefaults_BBBB standardUserDefaults].apikey);
//    return apikey;
//}
//
//+ (NSString *)getApisecret{
//    NSString *apisecret = emptyString([AAAA_MyUserDefaults_BBBB standardUserDefaults].apisecret);
//    return apisecret;
//}
...
//        return;
//    }
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].compId = [dict newStringValueForKey:@"compId"];
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].orgId = [dict newStringValueForKey:@"orgId"];
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].orgName = [dict newStringValueForKey:@"orgName"];
//
//
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].longitude = [[dict newStringValueForKey:@"longitude"] doubleValue];
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].latitude  = [[dict newStringValueForKey:@"latitude"] doubleValue];
//
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].company_latitude = [dict newStringValueForKey:@"latitude"];
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].company_longitude = [dict newStringValueForKey:@"longitude"];
//
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].province = [dict newStringValueForKey:@"province"];
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].city     = [dict newStringValueForKey:@"city"];
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].district   = [dict newStringValueForKey:@"county"];
//    [AAAA_MyUserDefaults_BBBB standardUserDefaults].address   = [dict newStringValueForKey:@"address"];
//
...
//    [HAAAA_HttpManager_BBBB POST:Server_userCard_get parameters:nil success:^(id responseObject) {
...
//            
//            [AAAA_MyUserDefaults_BBBB standardUserDefaults].myName = [data newStringValueForKey:@"realName"];
//            [AAAA_MyUserDefaults_BBBB standardUserDefaults].myHeadImg = [data newStringValueForKey:@"headImg"];
//            [AAAA_MyUserDefaults_BBBB standardUserDefaults].myPosition = [data newStringValueForKey:@"position"];
//            [AAAA_MyUserDefaults_BBBB standardUserDefaults].myCompanyName = [data newStringValueForKey:@"compName"];
//
//        }
