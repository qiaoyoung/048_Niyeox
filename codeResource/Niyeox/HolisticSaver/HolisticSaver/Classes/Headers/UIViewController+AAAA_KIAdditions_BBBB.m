...
@implementation UIViewController (AAAA_KIAdditions_BBBB)
...
- (void)setNavBarBackGroundColor:(UIColor *)color{
    [self.navigationController.navigationBar setBackgroundImage:[AAAA_SNGradientHelper_BBBB getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:AAAA_SNGradientHelper_BBBBDirectionLevel] forBarMetrics:UIBarMetricsDefault];
