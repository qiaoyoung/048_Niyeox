...
@implementation AAAA_USERSDKConfigDelegate_BBBB
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        NSArray *types = [[AAAA_USERBundleSetting_BBBB sharedConfig] ignoreTeamNotificationTypes];
...
{
    NIMMessageType type = [AAAA_USERBundleSetting_BBBB sharedConfig].ignoreMessageType;
