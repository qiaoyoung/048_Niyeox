...
@interface AAAA_SpellingUnit_BBBB : NSObject<NSCoding>
@property (nonatomic,strong)    NSString *fullSpelling;
@property (nonatomic,strong)    NSString *shortSpelling;
@end

@interface AAAA_USERSpellingCenter_BBBB : NSObject
{
...
- (AAAA_SpellingUnit_BBBB *)spellingForString: (NSString *)source;    //全拼，简拼 (全是小写)
