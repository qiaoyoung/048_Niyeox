//
//  AAAA_USERFeedbackViewController_BBBB.m
//  NIM
//
...
@interface AAAA_USERFeedbackViewController_BBBB ()<UITextViewDelegate,TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
...
@property (strong, nonatomic) AAAA_LxGridView_BBBBFlowLayout *layout;

@property (nonatomic,strong) UILabel *numLabel;
@property (nonatomic, strong) AAAA_ZMONCustomLoadingView_BBBB *loadingView;
@end

@implementation AAAA_USERFeedbackViewController_BBBB
...
//    [AAAA_SVProgressHUD_BBBB show];
    ...
    [AAAA_HttpManager_BBBB uploadImagesWithURL:Server_other_feedback parameters:dict images:array imageNames:nameArray progress:^(NSProgress *progress) {
...
//        [AAAA_SVProgressHUD_BBBB dismiss];
        [self.loadingView animationClose];
        [AAAA_SVProgressHUD_BBBB showMessage:LangKey(@"group_info_activity_op_failed")];
    }];

    return;
    
//    [AAAA_HttpManager_BBBB getWithUrl:Server_other_feedback params:dict isShow:YES success:^(id responseObject) {
//        NSDictionary *resultDict = (NSDictionary *)responseObject;
//        NSString *code = [resultDict newStringValueForKey:@"code"];
//        NSString *msg = [resultDict newStringValueForKey:@"msg"];
//        [AAAA_SVProgressHUD_BBBB showMessage:msg];
...
- (UIImagePickerController *)imagePickerVc {
    if (_imagePickerVc == nil) {
        ...
        _imagePickerVc.navigationBar.barTintColor = [UIColor colorWithPatternImage:[AAAA_SNGradientHelper_BBBB getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:AAAA_SNGradientHelper_BBBBDirectionLevel]];
...
- (void)configCollectionView {
    // 如不需要长按排序效果，将AAAA_LxGridView_BBBBFlowLayout类改成UICollectionViewFlowLayout即可
    _layout = [[AAAA_LxGridView_BBBBFlowLayout alloc] init];
...
//    _collectionView.backgroundColor = [UIColor colorWithRed:rgb green:rgb blue:rgb alpha:1.0];
    ...
    [_collectionView registerClass:[AAAA_TZTestCell_BBBB class] forCellWithReuseIdentifier:@"AAAA_TZTestCell_BBBB"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    AAAA_TZTestCell_BBBB *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"AAAA_TZTestCell_BBBB" forIndexPath:indexPath];
...
#pragma mark - AAAA_LxGridView_BBBBDataSource
