...
@interface AAAA_NSSetAvater_BBBB ()
...
@implementation AAAA_NSSetAvater_BBBB
...
////        [_cameraBtn layoutButtonWithEdgeInsetsStyle:(AAAA_ImageTitleSpacing_BBBBEdgeInsetsStyleTop) imageTitleSpace:0];
...
//        [_cameraBtn setImage:[UIImage imageNamed:@"ic_camera"] forState:UIControlStateNormal];
//        [_cameraBtn layoutButtonWithEdgeInsetsStyle:(AAAA_ImageTitleSpacing_BBBBEdgeInsetsStyleTop) imageTitleSpace:10];
...
////        [_albumBtn layoutButtonWithEdgeInsetsStyle:(AAAA_ImageTitleSpacing_BBBBEdgeInsetsStyleTop) imageTitleSpace:10];
//        _albumBtn.tag = 102;
