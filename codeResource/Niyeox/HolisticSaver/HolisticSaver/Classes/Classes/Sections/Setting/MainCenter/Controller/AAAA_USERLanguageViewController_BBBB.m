//
//  AAAA_USERLanguageViewController_BBBB.m
//  NIM
//
...
@interface AAAA_USERLanguageViewController_BBBB ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation AAAA_USERLanguageViewController_BBBB
...
//    self.tableView.layer.cornerRadius = 12;
    ...
    [self.tableView registerClass:[AAAA_USERLanguageTableViewCell_BBBB class] forCellReuseIdentifier:@"lang"];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    AAAA_USERLanguageTableViewCell_BBBB *cell = [self.tableView dequeueReusableCellWithIdentifier:@"lang" forIndexPath:indexPath];
...
- (void)changedLanguages:(NSString *)lang {
    ...
    [[AAAA_MyUserDefaults_BBBB standardUserDefaults] updateLanguageWith:lang];
