//
//  AAAA_USERThreadSessionConfig_BBBB.m
//  NIM
//
...
@interface AAAA_USERThreadSessionConfig_BBBB ()

@property (nonatomic,strong) AAAA_USERThreadDataSourceProvider_BBBB *provider;

@property (nonatomic,strong) NIMMessage *threadMessage;

@end

@implementation AAAA_USERThreadSessionConfig_BBBB
...
- (instancetype)initWithMessage:(NIMMessage *)message
{
    ...
    if (self)
    {
        ...
        _provider = [[AAAA_USERThreadDataSourceProvider_BBBB alloc] init];
        _provider.threadMessage = message;
    }
    return self;
}

- (id<AAAA_FFFKitMessageProvider_BBBB>)messageDataProvider
{
...
@interface AAAA_USERThreadDataSourceProvider_BBBB ()

@property (nonatomic,assign) BOOL didInsertThreadMessage;

@end

@implementation AAAA_USERThreadDataSourceProvider_BBBB

- (void)pullDown:(NIMMessage *)firstMessage handler:(NIMKitDataProvideHandler)handler
{
    BOOL enablePullCloudMessages = [[AAAA_USERBundleSetting_BBBB sharedConfig] enablePullSubMessagesFromServer];
