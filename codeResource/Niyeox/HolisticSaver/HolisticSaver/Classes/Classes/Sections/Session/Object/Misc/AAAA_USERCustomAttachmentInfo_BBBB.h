//
//  AAAA_USERCustomAttachmentInfo_BBBB.h
//  NIM
//
...
typedef NS_ENUM(NSInteger,AAAA_USERCustomAttachmentInfo_BBBBType){
    AAAA_USERCustomAttachmentInfo_BBBBTypeJanKenPon  = 1, //剪子石头布
    AAAA_USERCustomAttachmentInfo_BBBBTypeSnapchat   = 2, //阅后即焚
    AAAA_USERCustomAttachmentInfo_BBBBTypeChartlet   = 3, //贴图表情
    AAAA_USERCustomAttachmentInfo_BBBBTypeWhiteboard = 4, //白板会话
    AAAA_USERCustomAttachmentInfo_BBBBTypeRedPacket  = 5, //红包消息
    AAAA_USERCustomAttachmentInfo_BBBBTypeRedPacketTip = 6, //红包提示消息
    AAAA_USERCustomAttachmentInfo_BBBBTypeMultiRetweet = 15,//多条消息合并转发
    
    AAAA_USERCustomAttachmentInfo_BBBBTypeCard = 105,
};
...
@protocol AAAA_USERCustomAttachmentInfo_BBBB <NSObject>
