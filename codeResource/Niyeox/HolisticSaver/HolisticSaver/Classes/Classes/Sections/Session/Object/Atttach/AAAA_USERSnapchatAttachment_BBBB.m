...
@interface AAAA_USERSnapchatAttachment_BBBB()

@property (nonatomic,assign) BOOL isFromMe;

@end

@implementation AAAA_USERSnapchatAttachment_BBBB
...
- (NSString *)filepath
{
    ...
    return [AAAA_USERFileLocationHelper_BBBB filepathForImage:filename];
}


- (NSString *)cellContent:(NIMMessage *)message{
    self.isFromMe = message.isOutgoingMsg;
    return @"AAAA_USERSessionSnapchatContentView_BBBB";
}
...
- (NSString *)encodeAttachment
{
    ...
    [dict setObject:@(AAAA_USERCustomAttachmentInfo_BBBBTypeSnapchat) forKey:CMType];
