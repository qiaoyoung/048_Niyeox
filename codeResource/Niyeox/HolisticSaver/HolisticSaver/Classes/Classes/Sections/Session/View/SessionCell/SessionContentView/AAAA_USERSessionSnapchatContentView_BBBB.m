//
//  AAAA_USERSessionSnapchatContentView_BBBB.m
//  NIM
//
...
@interface AAAA_USERSessionSnapchatContentView_BBBB()
...
@implementation AAAA_USERSessionSnapchatContentView_BBBB
...
- (void)refresh:(AAAA_FFFMessageModel_BBBB *)model{
    ...
    AAAA_USERSnapchatAttachment_BBBB *attachment = (AAAA_USERSnapchatAttachment_BBBB *)customObject.attachment;
    self.imageView.image               = attachment.showCoverImage;
    self.label.hidden                  = attachment.isFired;
    self.longpressGesture.enabled      = !attachment.isFired;
    
    //禁用掉AAAA_FFFMessageCell_BBBB中的长按手势，防止手势冲突
