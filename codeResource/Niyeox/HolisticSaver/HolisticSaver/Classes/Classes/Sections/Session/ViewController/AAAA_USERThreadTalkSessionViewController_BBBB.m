//
//  AAAA_USERThreadTalkSessionViewController_BBBB.m
//  NIM
//
...
@interface AAAA_USERThreadTalkSessionViewController_BBBB ()
@property (nonatomic,strong) NIMMessage *threadMesssage;
@property (nonatomic,strong) AAAA_USERThreadSessionConfig_BBBB *sessionConfig;
@end

@implementation AAAA_USERThreadTalkSessionViewController_BBBB
...
- (id<AAAA_FFFSessionConfig_BBBB>)sessionConfig
{
    if (_sessionConfig == nil) {
        _sessionConfig = [[AAAA_USERThreadSessionConfig_BBBB alloc] initWithMessage:self.threadMesssage];
