//
//  AAAA_USERSubscribeManager_BBBB.m
//  NIM
//
...
@interface AAAA_USERSubscribeManager_BBBB()<NIMEventSubscribeManagerDelegate,NIMConversationManagerDelegate,NIMLoginManagerDelegate,NIMUserManagerDelegate>
...
@implementation AAAA_USERSubscribeManager_BBBB

+ (instancetype)sharedManager
{
    static AAAA_USERSubscribeManager_BBBB *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[AAAA_USERSubscribeManager_BBBB alloc] init];
    });
    return instance;
...
- (void)publishOnlineState
{
    ...
    event.value = AAAA_USERCustomState_BBBBValueOnlineExt;
    event.sendToOnlineUsersOnly = NO;  //必须要让后登录的用户也能拿到    
    NSDictionary *ext = @{@"net_state" : @([AAAA_USERDevice_BBBB currentDevice].currentNetworkType),
                          @"online_state" : @(AAAA_USEROnline_BBBBStateNormal), //移动端永远在线
                          };
