...
@implementation AAAA_SNGradientHelper_BBBB
...
+ (UIImage *)getLinearGradientImage:(UIColor *)startColor and:(UIColor *)endColor directionType:(AAAA_SNGradientHelper_BBBBDirection)directionType option:(CGSize)size {
    ...
    if (directionType == AAAA_SNGradientHelper_BBBBDirectionLevel) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 0);
    }else if (directionType == AAAA_SNGradientHelper_BBBBDirectionVertical){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(0, 1);
    }else if (directionType == AAAA_SNGradientHelper_BBBBDirectionVerticalOverTurn){
        gradientLayer.startPoint = CGPointMake(0, 1);
        gradientLayer.endPoint = CGPointMake(0, 0);
    }else if (directionType == AAAA_SNGradientHelper_BBBBDirectionUpwardDiagonalLine){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 1);
    }else if (directionType == AAAA_SNGradientHelper_BBBBDirectionDownDiagonalLine){
        gradientLayer.startPoint = CGPointMake(0, 1);
        gradientLayer.endPoint = CGPointMake(1, 0);
    }
