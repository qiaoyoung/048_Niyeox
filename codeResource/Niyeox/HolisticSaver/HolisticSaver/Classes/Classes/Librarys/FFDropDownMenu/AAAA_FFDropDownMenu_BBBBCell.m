//
//  AAAA_FFDropDownMenu_BBBBCell.m
...
@interface AAAA_FFDropDownMenu_BBBBCell ()

@end

@implementation AAAA_FFDropDownMenu_BBBBCell
...
- (void)setMenuModel:(id)menuModel {
    ...
    AAAA_FFDropDownMenu_BBBBModel *realMenuModel = (AAAA_FFDropDownMenu_BBBBModel *)menuModel;
