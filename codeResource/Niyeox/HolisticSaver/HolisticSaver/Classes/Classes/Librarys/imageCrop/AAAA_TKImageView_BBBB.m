...
typedef NS_ENUM(NSInteger, AAAA_TKCropAreaCorner_BBBBPosition) {
    AAAA_TKCropAreaCorner_BBBBPositionTopLeft,
    AAAA_TKCropAreaCorner_BBBBPositionTopRight,
    AAAA_TKCropAreaCorner_BBBBPositionBottomLeft,
    AAAA_TKCropAreaCorner_BBBBPositionBottomRight
};
typedef NS_ENUM(NSInteger, AAAA_TKMidLineType_BBBB) {
    
    AAAA_TKMidLineType_BBBBTop,
    AAAA_TKMidLineType_BBBBBottom,
    AAAA_TKMidLineType_BBBBLeft,
    AAAA_TKMidLineType_BBBBRight
...
@end
@interface AAAA_CornerView_BBBB: UIView

@property (assign, nonatomic) CGFloat lineWidth;
@property (strong, nonatomic) UIColor *lineColor;
@property (assign, nonatomic) AAAA_TKCropAreaCorner_BBBBPosition cornerPosition;
@property (assign, nonatomic) AAAA_CornerView_BBBB *relativeViewX;
@property (assign, nonatomic) AAAA_CornerView_BBBB *relativeViewY;
@property (strong, nonatomic) CAShapeLayer *cornerShapeLayer;

- (void)updateSizeWithWidth: (CGFloat)width height: (CGFloat)height;
@end
@implementation AAAA_CornerView_BBBB
...
- (void)setCornerPosition:(AAAA_TKCropAreaCorner_BBBBPosition)cornerPosition {
...
- (void)drawCornerLines {
    ...
    switch (_cornerPosition) {
        case AAAA_TKCropAreaCorner_BBBBPositionTopLeft: {
        ...
        case AAAA_TKCropAreaCorner_BBBBPositionTopRight: {
        ...
        case AAAA_TKCropAreaCorner_BBBBPositionBottomLeft: {
        ...
        case AAAA_TKCropAreaCorner_BBBBPositionBottomRight: {
...
@interface AAAA_MidLineView_BBBB : UIView
@property (strong, nonatomic) CAShapeLayer *lineLayer;
@property (assign, nonatomic) CGFloat lineWidth;
@property (assign, nonatomic) CGFloat lineHeight;
@property (strong, nonatomic) UIColor *lineColor;
@property (assign, nonatomic) AAAA_TKMidLineType_BBBB type;
@end
@implementation AAAA_MidLineView_BBBB
...
- (void)setType:(AAAA_TKMidLineType_BBBB)type {
...
- (void)drawMidLine {
    ...
    switch (_type) {
        case AAAA_TKMidLineType_BBBBTop:
        case AAAA_TKMidLineType_BBBBBottom: {
        ...
        case AAAA_TKMidLineType_BBBBRight:
        case AAAA_TKMidLineType_BBBBLeft: {
...
@interface AAAA_CropAreaView_BBBB : UIView
...
@end
@implementation AAAA_CropAreaView_BBBB
...
@property (strong, nonatomic) AAAA_CornerView_BBBB *topLeftCorner;
@property (strong, nonatomic) AAAA_CornerView_BBBB *topRightCorner;
@property (strong, nonatomic) AAAA_CornerView_BBBB *bottomLeftCorner;
@property (strong, nonatomic) AAAA_CornerView_BBBB *bottomRightCorner;
@property (strong, nonatomic) AAAA_CropAreaView_BBBB *cropAreaView;
...
@property (strong, nonatomic) AAAA_MidLineView_BBBB *topMidLine;
@property (strong, nonatomic) AAAA_MidLineView_BBBB *leftMidLine;
@property (strong, nonatomic) AAAA_MidLineView_BBBB *bottomMidLine;
@property (strong, nonatomic) AAAA_MidLineView_BBBB *rightMidLine;
...
- (void)setUp {
    ...
    _cropAreaView = [[AAAA_CropAreaView_BBBB alloc] init];
...
- (void)handleMidPan: (UIPanGestureRecognizer *)panGesture {
    ...
    AAAA_MidLineView_BBBB *midLineView = (AAAA_MidLineView_BBBB *)panGesture.view;
    switch (panGesture.state) {
        case UIGestureRecognizerStateBegan: {
...
- (void)handleCornerPan: (UIPanGestureRecognizer *)panGesture {
    ...
    AAAA_CornerView_BBBB *panView = (AAAA_CornerView_BBBB *)panGesture.view;
    AAAA_CornerView_BBBB *relativeViewX = panView.relativeViewX;
    AAAA_CornerView_BBBB *relativeViewY = panView.relativeViewY;
...
- (void)createCorners {
    _topLeftCorner = [[AAAA_CornerView_BBBB alloc]initWithFrame: CGRectMake(0, 0, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor:_cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _topLeftCorner.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleRightMargin;
    _topLeftCorner.cornerPosition = AAAA_TKCropAreaCorner_BBBBPositionTopLeft;
    
    _topRightCorner = [[AAAA_CornerView_BBBB alloc]initWithFrame: CGRectMake(WIDTH(_imageView) -  _cropAreaCornerWidth, 0, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor: _cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _topRightCorner.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleLeftMargin;
    _topRightCorner.cornerPosition = AAAA_TKCropAreaCorner_BBBBPositionTopRight;
    
    _bottomLeftCorner = [[AAAA_CornerView_BBBB alloc]initWithFrame: CGRectMake(0, HEIGHT(_imageView) -  _cropAreaCornerHeight, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor: _cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _bottomLeftCorner.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleRightMargin;
    _bottomLeftCorner.cornerPosition = AAAA_TKCropAreaCorner_BBBBPositionBottomLeft;
    
    _bottomRightCorner = [[AAAA_CornerView_BBBB alloc]initWithFrame: CGRectMake(WIDTH(_imageView) - _cropAreaCornerWidth, HEIGHT(_imageView) -  _cropAreaCornerHeight, _cropAreaCornerWidth, _cropAreaCornerHeight) lineColor: _cropAreaCornerLineColor lineWidth: _cropAreaCornerLineWidth];
    _bottomRightCorner.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleLeftMargin;
    _bottomRightCorner.cornerPosition = AAAA_TKCropAreaCorner_BBBBPositionBottomRight;
...
- (void)createMidLines {
    ...
    _topMidLine = [[AAAA_MidLineView_BBBB alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _topMidLine.type = AAAA_TKMidLineType_BBBBTop;
    
    _bottomMidLine = [[AAAA_MidLineView_BBBB alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _bottomMidLine.type = AAAA_TKMidLineType_BBBBBottom;
    
    _leftMidLine = [[AAAA_MidLineView_BBBB alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _leftMidLine.type = AAAA_TKMidLineType_BBBBLeft;
    
    _rightMidLine = [[AAAA_MidLineView_BBBB alloc]initWithLineWidth: _cropAreaMidLineWidth lineHeight: _cropAreaMidLineHeight lineColor: _cropAreaMidLineColor];
    _rightMidLine.type = AAAA_TKMidLineType_BBBBRight;
