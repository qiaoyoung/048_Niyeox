...
@implementation AAAA_MyViewController_BBBB
...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.barTintColor = [UIColor colorWithPatternImage:[AAAA_SNGradientHelper_BBBB getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:AAAA_SNGradientHelper_BBBBDirectionLevel]];
...
@implementation UIViewController (AAAA_HM_BBBB)
