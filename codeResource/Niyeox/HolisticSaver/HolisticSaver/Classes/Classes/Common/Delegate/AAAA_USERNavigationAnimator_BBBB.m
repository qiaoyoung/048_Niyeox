//
//  AAAA_USERNavigationAnimator_BBBB.m
//  NIM
//
...
@implementation AAAA_USERNavigationAnimator_BBBB
CG_INLINE BOOL
...
- (void)popAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    UITabBar *tabbar = [AAAA_USERMainTab_BBBBController instance].tabBar;
    UIView *containerView = [transitionContext containerView];
    ...
    if (self.animationType == AAAA_USERNavigationAnimator_BBBBTypeCross) {
    ...
    [UIView animateWithDuration:duration animations:^{
        ...
        [[AAAA_USERMainTab_BBBBController instance].view addSubview:tabbar];
