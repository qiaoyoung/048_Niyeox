...
@interface AAAA_FFFBadgeView_BBBB ()
...
@implementation AAAA_FFFBadgeView_BBBB

+ (instancetype)viewWithBadgeTip:(NSString *)badgeValue{
    if (!badgeValue) {
        badgeValue = @"";
    }
    AAAA_FFFBadgeView_BBBB *instance = [[AAAA_FFFBadgeView_BBBB alloc] init];
