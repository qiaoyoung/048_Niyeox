//
//  AAAA_FFFSessionVideoContentView_BBBB.m
// AAAA_MyUserKit_BBBB
//
...
@interface AAAA_FFFSessionVideoContentView_BBBB()
...
@property (nonatomic, strong) AAAA_UCZProgressView_BBBB *progress;
@property (nonatomic, strong) UIActivityIndicatorView *activity;
@end

@implementation AAAA_FFFSessionVideoContentView_BBBB
...
- (AAAA_USERAVMoviePlay_BBBBController *)avPlayer {
    if (!_avPlayer) {
        _avPlayer = [[AAAA_USERAVMoviePlay_BBBBController alloc] initWithContentURL:self.fileURL];
