//
//  AAAA_FFFTeamCardOperationViewController_BBBB.m
// AAAA_MyUserKit_BBBB
//
...
@implementation AAAA_FFFTeamCardOperationViewController_BBBB
...
- (instancetype)initWithTeam:(NIMTeam *)team
                     session:(NIMSession *)session
                      option:(AAAA_FFFTeamCardViewController_BBBBOption *)option {
    if (self = [super init]) {
        _option = option;
        _teamListManager = [[AAAA_FFFTeamListDataManager_BBBB alloc] initWithTeam:team session:session];
...
- (void)didFetchTeamMember:(AAAA_FFFMembersFetchOption_BBBB *)option {
...
@implementation AAAA_FFFTeamCardViewController_BBBBOption
