//
//  AAAA_FFFReplyedTextContentView_BBBB.m
// AAAA_MyUserKit_BBBB
//
...
@interface AAAA_FFFReplyedTextContentView_BBBB ()<AAAA_StringAttributedLabelDelegate_BBBB>
@end

@implementation AAAA_FFFReplyedTextContentView_BBBB
...
//            CGFloat customWidth = 50;
    ...
    AAAA_FFFKitSetting_BBBB *setting = [[AAAA_MyUserKit_BBBB sharedKit].config repliedSetting:data.message];
...
- (AAAA_StringAttributedLabel_BBBB *)textLabel
{
    if (!_textLabel)
    {
