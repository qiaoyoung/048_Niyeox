//
//  AAAA_StringAttributedLabel_BBBB.m
...
@interface AAAA_StringAttributedLabel_BBBB ()
@property (nonatomic,strong)    NSMutableAttributedString   *attributedString;
@property (nonatomic,strong)    NSMutableArray              *linkLocations;
@property (nonatomic,strong)    AAAA_StringAttributedLabel_BBBBURL       *touchedLink;
...
@implementation AAAA_StringAttributedLabel_BBBB
...
- (NSMutableAttributedString *)transformEmojiDescToEomjiImageWithAttributedString:(NSAttributedString *)attributedString {
    ...
    if (attrM.length > 0) {
        ...
        NSArray<NSTextCheckingResult *> *emoticonResults = [[AAAA_StringAttributedLabel_BBBB regexEmoticon] matchesInString:attrM.string options:kNilOptions range:attrM.yy_rangeOfAll];
