...
@interface AAAA_FFFTeamAnnouncementListCell_BBBB ()
@property (strong, nonatomic) UILabel *titleLabel;
@property (strong, nonatomic) UILabel *infoLabel;
@property (strong, nonatomic) UIView *line;
@property (strong, nonatomic) AAAA_StringAttributedLabel_BBBB *contentLabel;

@end

@implementation AAAA_FFFTeamAnnouncementListCell_BBBB
...
//        self.layer.cornerRadius = 10;
        ...
        _contentLabel = [[AAAA_StringAttributedLabel_BBBB alloc] initWithFrame:CGRectMake(15, 73, SCREEN_WIDTH-30-30, 178)];
        ...
        @weakify(self);
        _contentLabel.selectBlock = ^(AAAA_FFFMediaItem_BBBB *item) {
            @strongify(self);
