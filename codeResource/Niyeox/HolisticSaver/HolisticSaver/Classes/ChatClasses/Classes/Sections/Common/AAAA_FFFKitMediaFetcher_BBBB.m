//
// AAAA_MyUserKit_BBBBPhotoFetcher.m
// AAAA_MyUserKit_BBBB
//
...
@interface AAAA_FFFKitMediaFetcher_BBBB()<AAAA_FFFKitMediaPickerDelegate_BBBB,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@property (nonatomic,strong) AAAA_FFFKitMediaPickerController_BBBB  *assetsPicker;

@end

@implementation AAAA_FFFKitMediaFetcher_BBBB
...
- (void)setupPicker:(void(^)(UIViewController * _Nullable picker)) handler {
    ...
    AAAA_FFFKitMediaPickerController_BBBB *vc = [[AAAA_FFFKitMediaPickerController_BBBB alloc] initWithMaxImagesCount:self.limit];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if ([mediaType isEqualToString:(NSString *)kUTTypeMovie]) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            NSString *outputFileName = [AAAA_FFFKitFileLocationHelper_BBBB genFilenameWithExt:@"mp4"];
            NSString *outputPath = [AAAA_FFFKitFileLocationHelper_BBBB filepathForVideo:outputFileName];
