//
//  AAAA_FFFTeamMemberListDataSource_BBBB.h
// AAAA_MyUserKit_BBBB
//
...
typedef void(^NIMTeamMuteListDataBlock)(NSError * _Nullable error, NSMutableArray<AAAA_FFFTeamCardMemberItem_BBBB *> * _Nullable members);
NS_ASSUME_NONNULL_BEGIN


@protocol AAAA_FFFTeamOperation_BBBB <NSObject>
...
//查询群成员
- (void)fetchTeamMembersWithOption:(AAAA_FFFMembersFetchOption_BBBB * _Nullable )option
                        completion:(NIMTeamListDataBlock)completion;
...
@protocol AAAA_FFFTeamMemberListDataSource_BBBB <AAAA_FFFTeamOperation_BBBB>
...
- (NSMutableArray <AAAA_FFFTeamCardMemberItem_BBBB *> *)members;

- (AAAA_FFFTeamCardMemberItem_BBBB *)myCard;
