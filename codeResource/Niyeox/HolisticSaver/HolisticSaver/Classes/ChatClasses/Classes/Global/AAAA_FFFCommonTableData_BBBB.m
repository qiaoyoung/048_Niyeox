//
//  AAAA_FFFCommonTableData_BBBB.m
//  NIM
//
...
@implementation AAAA_NIMCommonTableSection_BBBB
...
- (instancetype) initWithDict:(NSDictionary *)dict{
    ...
    if (self) {
        ...
        _rows = [AAAA_NIMCommonTableRow_BBBB rowsWithData:dict[RowContent]];
    }
    return self;
}
...
+ (NSArray *)sectionsWithData:(NSArray *)data{
    ...
    for (NSDictionary *dict in data) {
        if ([dict isKindOfClass:[NSDictionary class]]) {
            AAAA_NIMCommonTableSection_BBBB * section = [[AAAA_NIMCommonTableSection_BBBB alloc] initWithDict:dict];
            if (section) {
...
@implementation AAAA_NIMCommonTableRow_BBBB
...
+ (NSArray *)rowsWithData:(NSArray *)data{
    ...
    for (NSDictionary *dict in data) {
        if ([dict isKindOfClass:[NSDictionary class]]) {
            AAAA_NIMCommonTableRow_BBBB * row = [[AAAA_NIMCommonTableRow_BBBB alloc] initWithDict:dict];
            if (row) {
                [array addObject:row];
            }
        }
