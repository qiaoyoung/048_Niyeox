...
@interface AAAA_FFFKitUrlManager_BBBB ()<AAAA_FFFKitTimerHolder_BBBBDelegate>
...
@implementation AAAA_FFFKitUrlManager_BBBB

+ (instancetype)shareManager {
    static dispatch_once_t onceToken;
    static id instance = nil;
    dispatch_once(&onceToken, ^{
        instance = [[AAAA_FFFKitUrlManager_BBBB alloc] init];
    });
    return instance;
}
