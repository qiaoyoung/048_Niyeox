...
@interface AAAA_FFFCommonTableDelegate_BBBB()

@property (nonatomic,copy) NSArray *(^USERDataReceiver)(void);

@end

@implementation AAAA_FFFCommonTableDelegate_BBBB
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    AAAA_NIMCommonTableSection_BBBB *tableSection = self.data[section];
    return tableSection.rows.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    AAAA_NIMCommonTableSection_BBBB *tableSection = self.data[indexPath.section];
    AAAA_NIMCommonTableRow_BBBB     *tableRow     = tableSection.rows[indexPath.row];
    ...
    if (![cell respondsToSelector:@selector(refreshData:tableView:)]) {
        ...
        [(id<AAAA_FFFCommonTableViewCell_BBBB>)cell refreshData:tableRow tableView:tableView];
    }
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableRow.sepLeftEdge) {
        ...
        AAAA_NIMCommonTableSection_BBBB *section = self.data[indexPath.section];
...
#pragma mark - Private
- (void)refreshData:(AAAA_NIMCommonTableRow_BBBB *)rowData cell:(UITableViewCell *)cell{
