//
//  AAAA_FFFLanguageManager_BBBB.m
//  NIM
//
...
@interface AAAA_FFFLanguageManager_BBBB ()<NSXMLParserDelegate>
@property (nonatomic ,strong) NSString *currentElementName;
@end

@implementation AAAA_FFFLanguageManager_BBBB

static AAAA_FFFLanguageManager_BBBB *shareInstance = nil;

+ (AAAA_FFFLanguageManager_BBBB *)shareInstance{
    @synchronized(self) {
        if (shareInstance == nil) {
            shareInstance = [[AAAA_FFFLanguageManager_BBBB alloc] init];
...
+ (NSString *)getTextWithKey:(NSString *)key{
    NSMutableDictionary *dict = [AAAA_FFFLanguageManager_BBBB shareInstance].langDict;
...
//    [self.langDict removeAllObjects];
    ...
    NSString *xmlFilePath = [[[AAAA_ZipArchive_BBBBManager sharedManager] getXML_filePath] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@/%@.xml", langType, resourceType]];
    ...
    NSDictionary *result = [AAAA_FFFXMLReader_BBBB dictionaryForXMLData:xmlData error:&error];
...
//    NSString *language = [AAAA_MyUserDefaults_BBBB standardUserDefaults].language;
